                    ...
                    <ScrollView>
                        <View style={styles.action}>
                            <FormInput label="Amount"
                                       ...
                                       onChangeText={(val) => this.setState({spendAmount: val})}/>
                        </View>

                        <Picker
                            label="Program"
                            onValueChange={(val) => this.setState({programId: val})}
                            // selectedValue={this.state.currency}
                        >
                            {this.state.cards.map((card, index) => <Picker.Item value={card.related_loyalty_program.id}
                        ...
                        <View style={styles.qrcode}>
                            <QRCode
                                value={'{"userId": "'+this.state.userId+'", "id": "'+this.state.programId+'", "amount": "'+this.state.spendAmount+'" }'}
                                size={200}
                            />
                        </View>
                    </ScrollView>
